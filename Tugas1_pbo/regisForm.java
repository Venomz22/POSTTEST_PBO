...
public class regisForm extends JFrame{
    ...
    public void initialize() {
        //label form
        JLabel lbRegisForm = new JLabel("Form Pendaftaran",SwingConstants.CENTER);
        lbRegisForm.setFont(mainfont);
        //form username
        JLabel lbUsername = new JLabel("Nama");
        ...
        //form phone
        JLabel lbPhone = new JLabel("Nomor Telepon");
        lbPhone.setFont(mainfont);
        tfPhone = new JTextField();
        tfPhone.setFont(mainfont);
        //form address
        JLabel lbAddress = new JLabel("Alamat");
        lbAddress.setFont(mainfont);
        tfAddress = new JTextField();
        tfAddress.setFont(mainfont);
        //form password
        JLabel lbPassword = new JLabel("Kata Sandi");
        ...
        btnSimpan.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Username.isEmpty()||Email.isEmpty()||Phone.isEmpty()||Address.isEmpty()||Password.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Isi Form Yang Kosong");
                }else{
                    try {
