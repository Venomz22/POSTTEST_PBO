...
public class Main {
    ...
    public static void readBiota() throws IOException{
        ...
        for (int i = 0; i < biota.size(); i++) {
            System.out.println("        ( Biota ke " + (i+1) + " : " + biota.get(i).namaumum + " )");
            System.out.println("       ----------------------");
            System.out.println("Nama Ilmiah/Latin Biota Laut        : " + biota.get(i).namailmiah);
            System.out.println("Nama umum Biota Laut                : " + biota.get(i).namaumum);
            System.out.println("Status Biota Laut                   : " + biota.get(i).status);
            System.out.println("Kedalaman Laut Biota Laut (Meter)   : " + biota.get(i).kedalaman);
            System.out.println("Daerah Ditemukan Biota Laut         : " + biota.get(i).daerah);
            System.out.println("Tahun ditemukan Biota Laut          : " + biota.get(i).tahun);
            System.out.print("\n");
        }
    }
    ...
    public static void updateBiota() throws IOException{
        ...
        biota.get(index-1).namailmiah = setnamailmiah;
        biota.get(index-1).namaumum = setnamaumum;
        biota.get(index-1).status = setstatus;
        biota.get(index-1).kedalaman = setkedalaman;
        biota.get(index-1).daerah = setdaerah;
        biota.get(index-1).tahun = settahun;
