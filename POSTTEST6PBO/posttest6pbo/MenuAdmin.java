...
public class MenuAdmin implements admin1 {
    ...
    public MenuAdmin(String username, String password) {
    ...
    public static void createBiota() throws IOException{
        ...
        switch (pilihan) {
            case 1:
                ...
                createBiota(addilmiahikan, addnamaikan, addwarnaikan, addkecepatanikan, addstatusikan, addkonsumsiikan, addkedalamanikan, adddaerahikan, addtahunikan);  
            break;
            ...
            case 2:
                ...
                createBiota(addilmiahkrustasea, addnamakrustasea, addstatuskrustasea, addkonsumsikrustasea, addkedalamankrustasea, adddaerahkrustasea, addtahunkrustasea, addjumlahkaki, addharga);
            break;
            ...
            case 3:
                ...
                createBiota(addilmiahkerang, addnamakerang, addstatuskerang, addkonsumsikerang, addkedalamankerang, adddaerahkerang, addtahunkerang, addbatas, addkolestrol);
            break;
            ...
            case 4:
                ...
                createBiota(addilmiahkarang, addnamakarang, addstatuskarang, addkonsumsikarang, addkedalamankarang, adddaerahkarang, addtahunkarang, addkoleksi, addberatkarang);
            break;
    ...
    public static void createBiota(String addilmiahikan, String addnamaikan, String addwarnaikan, int addkecepatanikan,
                                   String addstatusikan, String addkonsumsiikan, Double addkedalamanikan, String adddaerahikan, int addtahunikan) {
    ...
    public static void createBiota(String addilmiahkrustasea, String addnamakrustasea, String addstatuskrustasea, 
                                   String addkonsumsikrustasea, Double addkedalamankrustasea, String adddaerahkrustasea, int addtahunkrustasea, int addjumlahkaki, int addharga) {
                                    ...
                                    krustaseaBaru.isAdded();
    }

    public static void createBiota(String addilmiahkerang, String addnamakerang, String addstatuskerang, String addkonsumsikerang,
                                   Double addkedalamankerang, int addtahunkerang, String adddaerahkerang, int addbatas, int addkolestrol) {
    ...
    public static void createBiota(String addilmiahkarang, String addnamakarang, String addstatuskarang, String addkonsumsikarang,
                                    Double addkedalamankarang, String adddaerahkarang, int addtahunkarang, String addkoleksi, int addberatkarang){
    ...
    public static void updateBiota() throws IOException{
        ...
        case 2:
            ...
            krustasea.get(indexkrustasea-1).isUpdate();
        break;
        ...
        case 3:
            ...
            kerang.get(indexkerang-1).isUpdate();
        break;
        ...
        case 4:
            ...
            karang.get(indexkarang-1).isUpdate();
        break;
